...
const PostDetails = () => {
    ...
    return(
        <div>
            <Navbar/>
            {loader?<div className="h-[80vh] bg-pink-100 flex justify-center items-center w-full"><Loader/></div>:<div className="px-8 md:px-[200px] mt-8">
              ...
              <p>{new Date(post.updatedAt).toString().slice(16,24)}</p>
                ...
                <div className="w-full flex flex-col mt-4 md:flex-row">
                    <input onChange={(e)=>setComment(e.target.value)} type="text" placeholder="Napisi komentar" className="md-w-[80%] border-2 border-pink-700 outline-0 py-2 px-80 mt-4 md:mt-0"/>
