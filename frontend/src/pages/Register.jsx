...
const Register = () => {
    ...
    return(
        ...
        <h3 className="text-white font-extrabold"><Link to="/login">Uloguj se</Link></h3>
        </div>
        <div className="w-full bg-pink-100 flex justify-center items-center h-[80vh] ">
            <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%]">
                ...
                <div className="flex justify-center italic items-center space-x-3">
                    <p>Vec imate nalog?</p>
                    <p className="text-gray-500 hover:text-black underline"><Link to="/login">Uloguj se</Link></p>
                </div>
            </div>
        </div>
        <Footer/>
